        ...
        <div class="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
            <div class="min-w-0 flex-1">
                ...
                <p class="mt-3 text-stone-100">
                    Buat entri semester baru untuk sistem Akademix.
                </p>
            </div>
        </div>
    </div>
                ...
                <form action="{{ route('admin.semester.store') }}" method="POST">
                    ...
                    <div class="p-8 space-y-6">
                        <div>
                            ...
                            <input type="text" name="nama_semester" id="nama_semester" placeholder="Contoh: Ganjil 2024/2025" class="block w-full px-4 py-3 border border-gray-200 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition duration-200" required>
                        </div>
